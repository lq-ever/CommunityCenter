...
namespace CN.Jpush.Android.Api {
	...
	public partial class JPushInterface : global::Java.Lang.Object {
		...
		static IntPtr ACTION_UNREGISTER_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='cn.jpush.android.api']/class[@name='JPushInterface']/field[@name='ACTION_UNREGISTER']"
		[Register ("ACTION_UNREGISTER")]
		public static string ActionUnregister {
			get {
				if (ACTION_UNREGISTER_jfieldId == IntPtr.Zero)
					ACTION_UNREGISTER_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "ACTION_UNREGISTER", "Ljava/lang/String;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, ACTION_UNREGISTER_jfieldId);
				return JNIEnv.GetString (__ret, JniHandleOwnership.TransferLocalRef);
			}
		}
		...
		[Obsolete (@"deprecated")]
		[Register ("setAliasAndTags", "(Landroid/content/Context;Ljava/lang/String;Ljava/util/Set;)V", "")]
		public static unsafe void SetAliasAndTags (global::Android.Content.Context p0, string p1, global::System.Collections.Generic.ICollection<string> p2)
		{
			if (id_setAliasAndTags_Landroid_content_Context_Ljava_lang_String_Ljava_util_Set_ == IntPtr.Zero)
				id_setAliasAndTags_Landroid_content_Context_Ljava_lang_String_Ljava_util_Set_ = JNIEnv.GetStaticMethodID (class_ref, "setAliasAndTags", "(Landroid/content/Context;Ljava/lang/String;Ljava/util/Set;)V");
			IntPtr native_p1 = JNIEnv.NewString (p1);
			...
			try {
				...
				JNIEnv.CallStaticVoidMethod  (class_ref, id_setAliasAndTags_Landroid_content_Context_Ljava_lang_String_Ljava_util_Set_, __args);
			} finally {
				JNIEnv.DeleteLocalRef (native_p1);
		...
		static IntPtr id_setPushNotificationBuilder_Ljava_lang_Integer_Lcn_jpush_android_api_BasicPushNotificationBuilder_;
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.jpush.android.api']/class[@name='JPushInterface']/method[@name='setPushNotificationBuilder' and count(parameter)=2 and parameter[1][@type='java.lang.Integer'] and parameter[2][@type='cn.jpush.android.api.BasicPushNotificationBuilder']]"
		[Register ("setPushNotificationBuilder", "(Ljava/lang/Integer;Lcn/jpush/android/api/BasicPushNotificationBuilder;)V", "")]
		public static unsafe void SetPushNotificationBuilder (global::Java.Lang.Integer p0, global::CN.Jpush.Android.Api.BasicPushNotificationBuilder p1)
		{
			if (id_setPushNotificationBuilder_Ljava_lang_Integer_Lcn_jpush_android_api_BasicPushNotificationBuilder_ == IntPtr.Zero)
				id_setPushNotificationBuilder_Ljava_lang_Integer_Lcn_jpush_android_api_BasicPushNotificationBuilder_ = JNIEnv.GetStaticMethodID (class_ref, "setPushNotificationBuilder", "(Ljava/lang/Integer;Lcn/jpush/android/api/BasicPushNotificationBuilder;)V");
			try {
				JValue* __args = stackalloc JValue [2];
				__args [0] = new JValue (p0);
				__args [1] = new JValue (p1);
				JNIEnv.CallStaticVoidMethod  (class_ref, id_setPushNotificationBuilder_Ljava_lang_Integer_Lcn_jpush_android_api_BasicPushNotificationBuilder_, __args);
			} finally {
			}
		}
