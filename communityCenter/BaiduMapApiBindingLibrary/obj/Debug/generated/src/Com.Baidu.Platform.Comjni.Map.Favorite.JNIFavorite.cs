		...
		public virtual unsafe bool Add (long p0, string p1, string p2)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					__ret = JNIEnv.CallBooleanMethod  (Handle, id_Add_JLjava_lang_String_Ljava_lang_String_, __args);
				else
					__ret = JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "Add", "(JLjava/lang/String;Ljava/lang/String;)Z"), __args);
				return __ret;
			} finally {
...
#pragma warning restore 0169
		...
		public virtual unsafe bool Clear (long p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					return JNIEnv.CallBooleanMethod  (Handle, id_Clear_J, __args);
				else
					return JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "Clear", "(J)Z"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe int GetAll (long p0, global::Android.OS.Bundle p1)
		{
			...
			try {
				...
				int __ret;
				if (GetType () == ThresholdType)
					__ret = JNIEnv.CallIntMethod  (Handle, id_GetAll_JLandroid_os_Bundle_, __args);
				else
					__ret = JNIEnv.CallNonvirtualIntMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "GetAll", "(JLandroid/os/Bundle;)I"), __args);
				return __ret;
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe string GetValue (long p0, string p1)
		{
			...
			try {
				...
				string __ret;
				if (GetType () == ThresholdType)
					__ret = JNIEnv.GetString (JNIEnv.CallObjectMethod  (Handle, id_GetValue_JLjava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = JNIEnv.GetString (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "GetValue", "(JLjava/lang/String;)Ljava/lang/String;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p1);
			}
...
#pragma warning restore 0169
		...
		public virtual unsafe bool IsExist (long p0, string p1)
		{
			...
			try {
				...
				bool __ret;
				if (GetType () == ThresholdType)
					__ret = JNIEnv.CallBooleanMethod  (Handle, id_IsExist_JLjava_lang_String_, __args);
				else
					__ret = JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "IsExist", "(JLjava/lang/String;)Z"), __args);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p1);
			}
...
#pragma warning restore 0169
		...
		public virtual unsafe bool Load (long p0, string p1, string p2, string p3, int p4, int p5, int p6)
		{
			...
			try {
				...
				bool __ret;
				if (GetType () == ThresholdType)
					__ret = JNIEnv.CallBooleanMethod  (Handle, id_Load_JLjava_lang_String_Ljava_lang_String_Ljava_lang_String_III, __args);
				else
					__ret = JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "Load", "(JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;III)Z"), __args);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p1);
				JNIEnv.DeleteLocalRef (native_p2);
...
#pragma warning restore 0169
		...
		public virtual unsafe bool Remove (long p0, string p1)
		{
			...
			try {
				...
				bool __ret;
				if (GetType () == ThresholdType)
					__ret = JNIEnv.CallBooleanMethod  (Handle, id_Remove_JLjava_lang_String_, __args);
				else
					__ret = JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "Remove", "(JLjava/lang/String;)Z"), __args);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p1);
			}
...
#pragma warning restore 0169
		...
		public virtual unsafe bool SaveCache (long p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					return JNIEnv.CallBooleanMethod  (Handle, id_SaveCache_J, __args);
				else
					return JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "SaveCache", "(J)Z"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe bool SetType (long p0, int p1)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					return JNIEnv.CallBooleanMethod  (Handle, id_SetType_JI, __args);
				else
					return JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "SetType", "(JI)Z"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe bool Update (long p0, string p1, string p2)
		{
			...
			try {
				...
				bool __ret;
				if (GetType () == ThresholdType)
					__ret = JNIEnv.CallBooleanMethod  (Handle, id_Update_JLjava_lang_String_Ljava_lang_String_, __args);
				else
					__ret = JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "Update", "(JLjava/lang/String;Ljava/lang/String;)Z"), __args);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p1);
				JNIEnv.DeleteLocalRef (native_p2);
