			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.BaiduMap> (JNIEnv.CallObjectMethod  (Handle, id_getBaiduMap), JniHandleOwnership.TransferLocalRef);
					else
						return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.BaiduMap> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getBaiduMap", "()Lcom/baidu/mapapi/map/BaiduMap;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
		...
		public virtual unsafe global::Com.Baidu.Mapapi.Map.MapView MapView {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.MapView> (JNIEnv.CallObjectMethod  (Handle, id_getMapView), JniHandleOwnership.TransferLocalRef);
					else
						return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.MapView> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getMapView", "()Lcom/baidu/mapapi/map/MapView;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
