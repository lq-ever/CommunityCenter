	...
	public sealed partial class Text : global::Com.Baidu.Mapapi.Map.Overlay {
		...
		public unsafe int BgColor {
			...
			set {
				...
				try {
					...
					JNIEnv.CallVoidMethod  (Handle, id_setBgColor_I, __args);
				} finally {
				}
			}
		}
		...
		public unsafe int FontColor {
			...
			set {
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);
					JNIEnv.CallVoidMethod  (Handle, id_setFontColor_I, __args);
				} finally {
				}
			}
		}
		...
		public unsafe int FontSize {
			...
			set {
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);
					JNIEnv.CallVoidMethod  (Handle, id_setFontSize_I, __args);
				} finally {
				}
			}
		}
		...
		public unsafe global::Android.Graphics.Typeface Typeface {
			...
			set {
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);
					JNIEnv.CallVoidMethod  (Handle, id_setTypeface_Landroid_graphics_Typeface_, __args);
				} finally {
				}
			}
		}
		...
		public unsafe void SetAlign (int p0, int p1)
		{
			...
			try {
				...
				JNIEnv.CallVoidMethod  (Handle, id_setAlign_II, __args);
			} finally {
			}
		}
