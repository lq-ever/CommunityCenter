	...
	public sealed partial class ArcOptions : global::Com.Baidu.Mapapi.Map.OverlayOptions {
		...
		public unsafe global::Com.Baidu.Mapapi.Model.LatLng MiddlePoint {
			...
			get {
				...
				try {
					return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Model.LatLng> (JNIEnv.CallObjectMethod  (Handle, id_getMiddlePoint), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.ArcOptions InvokeColor (int p0)
		{
			...
			try {
				...
				return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.ArcOptions> (JNIEnv.CallObjectMethod  (Handle, id_color_I, __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.ArcOptions Visible (bool p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.ArcOptions> (JNIEnv.CallObjectMethod  (Handle, id_visible_Z, __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.ArcOptions InvokeWidth (int p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.ArcOptions> (JNIEnv.CallObjectMethod  (Handle, id_width_I, __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.ArcOptions InvokeZIndex (int p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.ArcOptions> (JNIEnv.CallObjectMethod  (Handle, id_zIndex_I, __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
