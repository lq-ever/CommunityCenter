	...
	public sealed partial class PolygonOptions : global::Com.Baidu.Mapapi.Map.OverlayOptions {
		...
		public unsafe global::Com.Baidu.Mapapi.Map.Stroke Stroke {
			...
			get {
				...
				try {
					return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.Stroke> (JNIEnv.CallObjectMethod  (Handle, id_getStroke), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.PolygonOptions InvokeExtraInfo (global::Android.OS.Bundle p0)
		{
			...
			try {
				...
				global::Com.Baidu.Mapapi.Map.PolygonOptions __ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.PolygonOptions> (JNIEnv.CallObjectMethod  (Handle, id_extraInfo_Landroid_os_Bundle_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.PolygonOptions InvokeFillColor (int p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.PolygonOptions> (JNIEnv.CallObjectMethod  (Handle, id_fillColor_I, __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.PolygonOptions InvokePoints (global::System.Collections.Generic.IList<global::Com.Baidu.Mapapi.Model.LatLng> p0)
		{
			...
			try {
				...
				global::Com.Baidu.Mapapi.Map.PolygonOptions __ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.PolygonOptions> (JNIEnv.CallObjectMethod  (Handle, id_points_Ljava_util_List_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
		...
		public unsafe global::Com.Baidu.Mapapi.Map.PolygonOptions InvokeStroke (global::Com.Baidu.Mapapi.Map.Stroke p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				global::Com.Baidu.Mapapi.Map.PolygonOptions __ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.PolygonOptions> (JNIEnv.CallObjectMethod  (Handle, id_stroke_Lcom_baidu_mapapi_map_Stroke_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.PolygonOptions Visible (bool p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.PolygonOptions> (JNIEnv.CallObjectMethod  (Handle, id_visible_Z, __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.PolygonOptions InvokeZIndex (int p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.PolygonOptions> (JNIEnv.CallObjectMethod  (Handle, id_zIndex_I, __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
