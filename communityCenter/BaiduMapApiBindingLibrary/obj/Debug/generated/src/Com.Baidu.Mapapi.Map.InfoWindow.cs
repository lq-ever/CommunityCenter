...
namespace Com.Baidu.Mapapi.Map {
	...
	public partial class InfoWindow : global::Java.Lang.Object {
		...
		public partial interface IOnInfoWindowClickListener : IJavaObject {
			...
			[Register ("onInfoWindowClick", "()V", "GetOnInfoWindowClickHandler:Com.Baidu.Mapapi.Map.InfoWindow/IOnInfoWindowClickListenerInvoker, BaiduMapApiBindingLibrary")]
...
#pragma warning restore 0169
			...
			public unsafe void OnInfoWindowClick ()
			{
				...
				JNIEnv.CallVoidMethod (Handle, id_onInfoWindowClick);
			}
...
#pragma warning restore 0649
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (InfoWindow)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Landroid/view/View;Lcom/baidu/mapapi/model/LatLng;I)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Landroid/view/View;Lcom/baidu/mapapi/model/LatLng;I)V", __args);
					return;
				}
				...
				SetHandle (
						...
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Landroid_view_View_Lcom_baidu_mapapi_model_LatLng_I, __args);
			} finally {
			}
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (InfoWindow)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Lcom/baidu/mapapi/map/BitmapDescriptor;Lcom/baidu/mapapi/model/LatLng;ILcom/baidu/mapapi/map/InfoWindow$OnInfoWindowClickListener;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Lcom/baidu/mapapi/map/BitmapDescriptor;Lcom/baidu/mapapi/model/LatLng;ILcom/baidu/mapapi/map/InfoWindow$OnInfoWindowClickListener;)V", __args);
					return;
				}
				...
				SetHandle (
						...
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lcom_baidu_mapapi_map_BitmapDescriptor_Lcom_baidu_mapapi_model_LatLng_ILcom_baidu_mapapi_map_InfoWindow_OnInfoWindowClickListener_, __args);
			} finally {
			}
		}
