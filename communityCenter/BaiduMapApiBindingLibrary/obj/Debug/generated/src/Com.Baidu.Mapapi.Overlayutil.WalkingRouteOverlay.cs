...
namespace Com.Baidu.Mapapi.Overlayutil {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.baidu.mapapi.overlayutil']/class[@name='WalkingRouteOverlay']"
	[global::Android.Runtime.Register ("com/baidu/mapapi/overlayutil/WalkingRouteOverlay", DoNotGenerateAcw=true)]
	public partial class WalkingRouteOverlay : global::Com.Baidu.Mapapi.Overlayutil.OverlayManager {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/baidu/mapapi/overlayutil/WalkingRouteOverlay", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (WalkingRouteOverlay); }
		}

		protected WalkingRouteOverlay (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lcom_baidu_mapapi_map_BaiduMap_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.baidu.mapapi.overlayutil']/class[@name='WalkingRouteOverlay']/constructor[@name='WalkingRouteOverlay' and count(parameter)=1 and parameter[1][@type='com.baidu.mapapi.map.BaiduMap']]"
		[Register (".ctor", "(Lcom/baidu/mapapi/map/BaiduMap;)V", "")]
		public unsafe WalkingRouteOverlay (global::Com.Baidu.Mapapi.Map.BaiduMap p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (WalkingRouteOverlay)) {
					SetHandle (
...
#pragma warning restore 0169
		...
		public virtual unsafe int LineColor {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.mapapi.overlayutil']/class[@name='WalkingRouteOverlay']/method[@name='getLineColor' and count(parameter)=0]"
		...
		public override unsafe global::System.Collections.Generic.IList<global::Com.Baidu.Mapapi.Map.OverlayOptions> OverlayOptions {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.mapapi.overlayutil']/class[@name='WalkingRouteOverlay']/method[@name='getOverlayOptions' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Baidu.Mapapi.Map.BitmapDescriptor StartMarker {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.mapapi.overlayutil']/class[@name='WalkingRouteOverlay']/method[@name='getStartMarker' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Baidu.Mapapi.Map.BitmapDescriptor TerminalMarker {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.mapapi.overlayutil']/class[@name='WalkingRouteOverlay']/method[@name='getTerminalMarker' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.mapapi.overlayutil']/class[@name='WalkingRouteOverlay']/method[@name='onMarkerClick' and count(parameter)=1 and parameter[1][@type='com.baidu.mapapi.map.Marker']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.mapapi.overlayutil']/class[@name='WalkingRouteOverlay']/method[@name='onPolylineClick' and count(parameter)=1 and parameter[1][@type='com.baidu.mapapi.map.Polyline']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.mapapi.overlayutil']/class[@name='WalkingRouteOverlay']/method[@name='onRouteNodeClick' and count(parameter)=1 and parameter[1][@type='int']]"
		...
		static Delegate cb_setData_Lcom_baidu_mapapi_search_route_WalkingRouteLine_;
#pragma warning disable 0169
		static Delegate GetSetData_Lcom_baidu_mapapi_search_route_WalkingRouteLine_Handler ()
		{
			if (cb_setData_Lcom_baidu_mapapi_search_route_WalkingRouteLine_ == null)
				cb_setData_Lcom_baidu_mapapi_search_route_WalkingRouteLine_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_SetData_Lcom_baidu_mapapi_search_route_WalkingRouteLine_);
			return cb_setData_Lcom_baidu_mapapi_search_route_WalkingRouteLine_;
		}
...
#pragma warning restore 0169
		...
		static IntPtr id_setData_Lcom_baidu_mapapi_search_route_WalkingRouteLine_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.mapapi.overlayutil']/class[@name='WalkingRouteOverlay']/method[@name='setData' and count(parameter)=1 and parameter[1][@type='com.baidu.mapapi.search.route.WalkingRouteLine']]"
		[Register ("setData", "(Lcom/baidu/mapapi/search/route/WalkingRouteLine;)V", "GetSetData_Lcom_baidu_mapapi_search_route_WalkingRouteLine_Handler")]
