		...
		com.handmark.pulltorefresh.library.PullToRefreshBase.OnRefreshListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("CommunityCenter.Activitys.Finance.BankCardsActivity, CommunityCenter, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", BankCardsActivity.class, __md_methods);
	}
	...
	public BankCardsActivity () throws java.lang.Throwable
	{
		...
		if (getClass () == BankCardsActivity.class)
			mono.android.TypeManager.Activate ("CommunityCenter.Activitys.Finance.BankCardsActivity, CommunityCenter, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
