	...
	public sealed partial class GroundOverlay : global::Com.Baidu.Mapapi.Map.Overlay {
		...
		public unsafe double Height {
			...
			get {
				...
				try {
					return JNIEnv.CallDoubleMethod  (Handle, id_getHeight);
				} finally {
				}
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.BitmapDescriptor Image {
			...
			set {
				...
				try {
					...
					JNIEnv.CallVoidMethod  (Handle, id_setImage_Lcom_baidu_mapapi_map_BitmapDescriptor_, __args);
				} finally {
				}
			}
		}
		...
		public unsafe float Transparency {
			...
			set {
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);
					JNIEnv.CallVoidMethod  (Handle, id_setTransparency_F, __args);
				} finally {
				}
			}
		}
		...
		public unsafe void SetDimensions (int p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallVoidMethod  (Handle, id_setDimensions_I, __args);
			} finally {
			}
		}
		...
		public unsafe void SetDimensions (int p0, int p1)
		{
			...
			try {
				...
				__args [0] = new JValue (p0);
				__args [1] = new JValue (p1);
				JNIEnv.CallVoidMethod  (Handle, id_setDimensions_II, __args);
			} finally {
			}
		}
		...
		public unsafe void SetPositionFromBounds (global::Com.Baidu.Mapapi.Model.LatLngBounds p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallVoidMethod  (Handle, id_setPositionFromBounds_Lcom_baidu_mapapi_model_LatLngBounds_, __args);
			} finally {
			}
		}
