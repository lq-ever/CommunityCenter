	...
	public sealed partial class DotOptions : global::Com.Baidu.Mapapi.Map.OverlayOptions {
		...
		public unsafe global::Com.Baidu.Mapapi.Map.DotOptions InvokeCenter (global::Com.Baidu.Mapapi.Model.LatLng p0)
		{
			...
			try {
				...
				global::Com.Baidu.Mapapi.Map.DotOptions __ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.DotOptions> (JNIEnv.CallObjectMethod  (Handle, id_center_Lcom_baidu_mapapi_model_LatLng_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.DotOptions InvokeColor (int p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.DotOptions> (JNIEnv.CallObjectMethod  (Handle, id_color_I, __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.DotOptions InvokeExtraInfo (global::Android.OS.Bundle p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				global::Com.Baidu.Mapapi.Map.DotOptions __ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.DotOptions> (JNIEnv.CallObjectMethod  (Handle, id_extraInfo_Landroid_os_Bundle_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.DotOptions InvokeRadius (int p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.DotOptions> (JNIEnv.CallObjectMethod  (Handle, id_radius_I, __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.DotOptions Visible (bool p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.DotOptions> (JNIEnv.CallObjectMethod  (Handle, id_visible_Z, __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.DotOptions InvokeZIndex (int p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.DotOptions> (JNIEnv.CallObjectMethod  (Handle, id_zIndex_I, __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
