	...
	public sealed partial class CircleOptions : global::Com.Baidu.Mapapi.Map.OverlayOptions {
		...
		public unsafe global::Com.Baidu.Mapapi.Map.CircleOptions InvokeExtraInfo (global::Android.OS.Bundle p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				global::Com.Baidu.Mapapi.Map.CircleOptions __ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.CircleOptions> (JNIEnv.CallObjectMethod  (Handle, id_extraInfo_Landroid_os_Bundle_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.CircleOptions InvokeFillColor (int p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.CircleOptions> (JNIEnv.CallObjectMethod  (Handle, id_fillColor_I, __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.CircleOptions InvokeRadius (int p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.CircleOptions> (JNIEnv.CallObjectMethod  (Handle, id_radius_I, __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.CircleOptions InvokeStroke (global::Com.Baidu.Mapapi.Map.Stroke p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				global::Com.Baidu.Mapapi.Map.CircleOptions __ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.CircleOptions> (JNIEnv.CallObjectMethod  (Handle, id_stroke_Lcom_baidu_mapapi_map_Stroke_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.CircleOptions Visible (bool p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.CircleOptions> (JNIEnv.CallObjectMethod  (Handle, id_visible_Z, __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.CircleOptions InvokeZIndex (int p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.CircleOptions> (JNIEnv.CallObjectMethod  (Handle, id_zIndex_I, __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
