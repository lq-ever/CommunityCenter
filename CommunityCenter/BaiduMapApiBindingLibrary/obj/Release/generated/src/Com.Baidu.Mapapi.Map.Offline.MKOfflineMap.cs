...
namespace Com.Baidu.Mapapi.Map.Offline {
	...
	public partial class MKOfflineMap : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (MKOfflineMap)) {
					SetHandle (
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return global::Android.Runtime.JavaList<global::Com.Baidu.Mapapi.Map.Offline.MKOLUpdateElement>.FromJniHandle (JNIEnv.CallObjectMethod  (Handle, id_getAllUpdateInfo), JniHandleOwnership.TransferLocalRef);
					else
						return global::Android.Runtime.JavaList<global::Com.Baidu.Mapapi.Map.Offline.MKOLUpdateElement>.FromJniHandle (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getAllUpdateInfo", "()Ljava/util/ArrayList;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
		...
		public virtual unsafe global::System.Collections.Generic.IList<global::Com.Baidu.Mapapi.Map.Offline.MKOLSearchRecord> HotCityList {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return global::Android.Runtime.JavaList<global::Com.Baidu.Mapapi.Map.Offline.MKOLSearchRecord>.FromJniHandle (JNIEnv.CallObjectMethod  (Handle, id_getHotCityList), JniHandleOwnership.TransferLocalRef);
					else
						return global::Android.Runtime.JavaList<global::Com.Baidu.Mapapi.Map.Offline.MKOLSearchRecord>.FromJniHandle (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getHotCityList", "()Ljava/util/ArrayList;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
		...
		public virtual unsafe global::System.Collections.Generic.IList<global::Com.Baidu.Mapapi.Map.Offline.MKOLSearchRecord> OfflineCityList {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return global::Android.Runtime.JavaList<global::Com.Baidu.Mapapi.Map.Offline.MKOLSearchRecord>.FromJniHandle (JNIEnv.CallObjectMethod  (Handle, id_getOfflineCityList), JniHandleOwnership.TransferLocalRef);
					else
						return global::Android.Runtime.JavaList<global::Com.Baidu.Mapapi.Map.Offline.MKOLSearchRecord>.FromJniHandle (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getOfflineCityList", "()Ljava/util/ArrayList;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Baidu.Mapapi.Map.Offline.MKOLUpdateElement GetUpdateInfo (int p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.Offline.MKOLUpdateElement> (JNIEnv.CallObjectMethod  (Handle, id_getUpdateInfo_I, __args), JniHandleOwnership.TransferLocalRef);
				else
					return global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Map.Offline.MKOLUpdateElement> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getUpdateInfo", "(I)Lcom/baidu/mapapi/map/offline/MKOLUpdateElement;"), __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe bool Remove (int p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					return JNIEnv.CallBooleanMethod  (Handle, id_remove_I, __args);
				else
					return JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "remove", "(I)Z"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.Generic.IList<global::Com.Baidu.Mapapi.Map.Offline.MKOLSearchRecord> SearchCity (string p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					__ret = global::Android.Runtime.JavaList<global::Com.Baidu.Mapapi.Map.Offline.MKOLSearchRecord>.FromJniHandle (JNIEnv.CallObjectMethod  (Handle, id_searchCity_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Android.Runtime.JavaList<global::Com.Baidu.Mapapi.Map.Offline.MKOLSearchRecord>.FromJniHandle (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "searchCity", "(Ljava/lang/String;)Ljava/util/ArrayList;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
...
#pragma warning restore 0169
		...
		public virtual unsafe bool Start (int p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					return JNIEnv.CallBooleanMethod  (Handle, id_start_I, __args);
				else
					return JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "start", "(I)Z"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe bool Update (int p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					return JNIEnv.CallBooleanMethod  (Handle, id_update_I, __args);
				else
					return JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "update", "(I)Z"), __args);
			} finally {
			}
		}
