	...
	public sealed partial class UiSettings : global::Java.Lang.Object {
		...
		public unsafe bool CompassEnabled {
			...
			set {
				...
				try {
					...
					JNIEnv.CallVoidMethod  (Handle, id_setCompassEnabled_Z, __args);
				} finally {
				}
			}
		}
		...
		public unsafe bool OverlookingGesturesEnabled {
			...
			get {
				...
				try {
					return JNIEnv.CallBooleanMethod  (Handle, id_isOverlookingGesturesEnabled);
				} finally {
				}
			}
			...
			set {
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);
					JNIEnv.CallVoidMethod  (Handle, id_setOverlookingGesturesEnabled_Z, __args);
				} finally {
				}
			}
		}
		...
		public unsafe bool RotateGesturesEnabled {
			...
			set {
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);
					JNIEnv.CallVoidMethod  (Handle, id_setRotateGesturesEnabled_Z, __args);
				} finally {
				}
			}
		}
		...
		public unsafe bool ScrollGesturesEnabled {
			...
			set {
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);
					JNIEnv.CallVoidMethod  (Handle, id_setScrollGesturesEnabled_Z, __args);
				} finally {
				}
			}
		}
		...
		public unsafe bool ZoomGesturesEnabled {
			...
			set {
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);
					JNIEnv.CallVoidMethod  (Handle, id_setZoomGesturesEnabled_Z, __args);
				} finally {
				}
			}
		}
		...
		public unsafe void SetAllGesturesEnabled (bool p0)
		{
			...
			try {
				...
				JNIEnv.CallVoidMethod  (Handle, id_setAllGesturesEnabled_Z, __args);
			} finally {
			}
		}

		static IntPtr id_setCompassPosition_Landroid_graphics_Point_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.mapapi.map']/class[@name='UiSettings']/method[@name='setCompassPosition' and count(parameter)=1 and parameter[1][@type='android.graphics.Point']]"
		[Register ("setCompassPosition", "(Landroid/graphics/Point;)V", "")]
