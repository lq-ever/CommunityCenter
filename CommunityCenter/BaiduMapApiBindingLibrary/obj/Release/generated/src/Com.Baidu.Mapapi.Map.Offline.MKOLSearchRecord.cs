	...
	public partial class MKOLSearchRecord : global::Java.Lang.Object {
		...
		public global::System.Collections.IList ChildCities {
			get {
				...
				IntPtr __ret = JNIEnv.GetObjectField (Handle, childCities_jfieldId);
			...
			set {
				...
				try {
					JNIEnv.SetField (Handle, childCities_jfieldId, native_value);
				} finally {
		...
		public int CityType {
			get {
				...
				return JNIEnv.GetIntField (Handle, cityType_jfieldId);
			}
			set {
				if (cityType_jfieldId == IntPtr.Zero)
					cityType_jfieldId = JNIEnv.GetFieldID (class_ref, "cityType", "I");
				try {
					JNIEnv.SetField (Handle, cityType_jfieldId, value);
				} finally {
				}
			}
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (MKOLSearchRecord)) {
					SetHandle (
