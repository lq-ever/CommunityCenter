	...
	public sealed partial class Marker : global::Com.Baidu.Mapapi.Map.Overlay {
		...
		public unsafe bool Draggable {
			...
			set {
				...
				try {
					...
					JNIEnv.CallVoidMethod  (Handle, id_setDraggable_Z, __args);
				} finally {
				}
			}
		}
		...
		public unsafe bool Flat {
			...
			set {
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);
					JNIEnv.CallVoidMethod  (Handle, id_setFlat_Z, __args);
				} finally {
				}
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Map.BitmapDescriptor Icon {
			...
			set {
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);
					JNIEnv.CallVoidMethod  (Handle, id_setIcon_Lcom_baidu_mapapi_map_BitmapDescriptor_, __args);
				} finally {
				}
			}
		}
		...
		public unsafe global::System.Collections.Generic.IList<global::Com.Baidu.Mapapi.Map.BitmapDescriptor> Icons {
			...
			set {
				...
				try {
					...
					JNIEnv.CallVoidMethod  (Handle, id_setIcons_Ljava_util_ArrayList_, __args);
				} finally {
		...
		public unsafe int Period {
			...
			set {
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);
					JNIEnv.CallVoidMethod  (Handle, id_setPeriod_I, __args);
				} finally {
				}
			}
		}
		...
		public unsafe bool Perspective {
			...
			set {
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);
					JNIEnv.CallVoidMethod  (Handle, id_setPerspective_Z, __args);
				} finally {
				}
			}
		}
		...
		public unsafe global::Com.Baidu.Mapapi.Model.LatLng Position {
			...
			set {
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);
					JNIEnv.CallVoidMethod  (Handle, id_setPosition_Lcom_baidu_mapapi_model_LatLng_, __args);
				} finally {
				}
			}
		}
		...
		public unsafe float Rotate {
			...
			set {
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);
					JNIEnv.CallVoidMethod  (Handle, id_setRotate_F, __args);
				} finally {
				}
			}
		}
		...
		public unsafe void SetAnchor (float p0, float p1)
		{
			...
			try {
				...
				JNIEnv.CallVoidMethod  (Handle, id_setAnchor_FF, __args);
			} finally {
			}
		}
		...
		public unsafe void SetToTop ()
		{
			...
			try {
				JNIEnv.CallVoidMethod  (Handle, id_setToTop);
			} finally {
			}
		}
