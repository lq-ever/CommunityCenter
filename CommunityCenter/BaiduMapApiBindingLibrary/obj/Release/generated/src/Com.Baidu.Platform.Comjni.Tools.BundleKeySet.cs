...
namespace Com.Baidu.Platform.Comjni.Tools {
	...
	public partial class BundleKeySet : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (BundleKeySet)) {
					SetHandle (
		...
		public virtual unsafe string[] GetBundleKeys (global::Android.OS.Bundle p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					__ret = (string[]) JNIEnv.GetArray (JNIEnv.CallObjectMethod  (Handle, id_getBundleKeys_Landroid_os_Bundle_, __args), JniHandleOwnership.TransferLocalRef, typeof (string));
				else
					__ret = (string[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getBundleKeys", "(Landroid/os/Bundle;)[Ljava/lang/String;"), __args), JniHandleOwnership.TransferLocalRef, typeof (string));
				return __ret;
			} finally {
			}
		}
