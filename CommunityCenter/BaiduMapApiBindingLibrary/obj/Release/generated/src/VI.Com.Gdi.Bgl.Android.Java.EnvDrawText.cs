	...
	public partial class EnvDrawText : global::Java.Lang.Object {
		...
		public static IList<int> Buffer {
			get {
				...
				return JavaArray<int>.FromJniHandle (JNIEnv.GetStaticObjectField (class_ref, buffer_jfieldId), JniHandleOwnership.TransferLocalRef);
			}
			set {
				if (buffer_jfieldId == IntPtr.Zero)
					buffer_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "buffer", "[I");
		...
		static IntPtr id_getTextSize_Ljava_lang_String_I;
		// Metadata.xml XPath method reference: path="/api/package[@name='vi.com.gdi.bgl.android.java']/class[@name='EnvDrawText']/method[@name='getTextSize' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='int']]"
		[Register ("getTextSize", "(Ljava/lang/String;I)[S", "")]
		public static unsafe short[] GetTextSize (string p0, int p1)
		{
			if (id_getTextSize_Ljava_lang_String_I == IntPtr.Zero)
				id_getTextSize_Ljava_lang_String_I = JNIEnv.GetStaticMethodID (class_ref, "getTextSize", "(Ljava/lang/String;I)[S");
			IntPtr native_p0 = JNIEnv.NewString (p0);
			try {
				JValue* __args = stackalloc JValue [2];
				__args [0] = new JValue (native_p0);
				__args [1] = new JValue (p1);
				short[] __ret = (short[]) JNIEnv.GetArray (JNIEnv.CallStaticObjectMethod  (class_ref, id_getTextSize_Ljava_lang_String_I, __args), JniHandleOwnership.TransferLocalRef, typeof (short));
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
			}
