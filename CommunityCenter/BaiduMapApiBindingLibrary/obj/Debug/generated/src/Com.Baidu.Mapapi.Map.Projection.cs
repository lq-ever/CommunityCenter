	...
	public sealed partial class Projection : global::Java.Lang.Object {
		...
		public unsafe global::Com.Baidu.Mapapi.Model.LatLng FromScreenLocation (global::Android.Graphics.Point p0)
		{
			...
			try {
				...
				global::Com.Baidu.Mapapi.Model.LatLng __ret = global::Java.Lang.Object.GetObject<global::Com.Baidu.Mapapi.Model.LatLng> (JNIEnv.CallObjectMethod  (Handle, id_fromScreenLocation_Landroid_graphics_Point_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
		...
		public unsafe float MetersToEquatorPixels (float p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				return JNIEnv.CallFloatMethod  (Handle, id_metersToEquatorPixels_F, __args);
			} finally {
			}
		}
		...
		public unsafe global::Android.Graphics.PointF ToOpenGLLocation (global::Com.Baidu.Mapapi.Model.LatLng p0, global::Com.Baidu.Mapapi.Map.MapStatus p1)
		{
			...
			try {
				...
				global::Android.Graphics.PointF __ret = global::Java.Lang.Object.GetObject<global::Android.Graphics.PointF> (JNIEnv.CallObjectMethod  (Handle, id_toOpenGLLocation_Lcom_baidu_mapapi_model_LatLng_Lcom_baidu_mapapi_map_MapStatus_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
		...
		public unsafe global::Android.Graphics.Point ToScreenLocation (global::Com.Baidu.Mapapi.Model.LatLng p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				global::Android.Graphics.Point __ret = global::Java.Lang.Object.GetObject<global::Android.Graphics.Point> (JNIEnv.CallObjectMethod  (Handle, id_toScreenLocation_Lcom_baidu_mapapi_model_LatLng_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
