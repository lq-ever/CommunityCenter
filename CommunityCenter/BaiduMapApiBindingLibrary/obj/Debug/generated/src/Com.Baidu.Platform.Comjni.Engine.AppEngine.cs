...
namespace Com.Baidu.Platform.Comjni.Engine {
	...
	public partial class AppEngine : global::Java.Lang.Object {
		...
		static IntPtr id_InitEngine_Landroid_content_Context_Landroid_os_Bundle_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.platform.comjni.engine']/class[@name='AppEngine']/method[@name='InitEngine' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.os.Bundle']]"
		[Register ("InitEngine", "(Landroid/content/Context;Landroid/os/Bundle;)Z", "")]
